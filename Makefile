...
SOURCES = \
	__init__.py \
	new_plugin.py new_plugin_dialog.py
...
UI_FILES = new_plugin_dialog_base.ui
...
QGISDIR=C:\Users\Ernesty Dameyani\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
